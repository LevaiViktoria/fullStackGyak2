    ...
    switch (true) {
        ...
        case req.url === "/halak" && req.method === "POST":
            ...
            req.on('end', () => {
                ...
                fs.readFile("./data/halak.json", (err, data) => {   //be kell olvasni
                    ...
                    fs.writeFile('./data/halak.json',JSON.stringify(halaim), () =>{   //bele kell írni 
